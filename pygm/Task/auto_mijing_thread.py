...
class Auto_mijing_Thread(Thread):
    ...
    def run(self):
        ...
        (img, x, y) = image_recog.find_template(template_path=p, image_path="活动.pic.png")
        if img is not None:
            print("找到活动按钮")
    ...
    def swipe_tp_top(self):
        leidianDevice.swipe(self.dev_name, 200, 200, 200, 300)
        leidianDevice.swipe(self.dev_name, 200, 200, 200, 400)

if __name__ == '__main__':
    c = Auto_mijing_Thread('device_name')
    c.start()
