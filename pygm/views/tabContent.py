...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tool_btn_4 = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.tool_btn_4.setObjectName("tool_btn_4")
        self.horizontalLayout_5.addWidget(self.tool_btn_4)
    ...
    def retranslateUi(self, Form):
        ...
        self.tool_btn_2.setText(_translate("Form", "截图"))
        self.tool_btn_3.setText(_translate("Form", "自动副本"))
        self.tool_btn_4.setText(_translate("Form", "记录当前金币"))
